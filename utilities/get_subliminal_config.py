...
try:
    ...
    config_data = {
        'tmdb_api_key': get_setting('TMDB', 'api_key', '81d6ee5a0aa9ca93989c3bb5103d57d5'),
        ...
        'omdb_api_key': get_setting('OMDB', 'api_key', '44d5b275')
    }
    ...
    fallback_config = {
        'tmdb_api_key': '81d6ee5a0aa9ca93989c3bb5103d57d5',
