...
ZILEAN_ENABLED = get_setting('Zilean', 'enabled', 'False')
if isinstance(ZILEAN_ENABLED, bool):
    ZILEAN_ENABLED = str(ZILEAN_ENABLED).lower()
ZILEAN_ENABLED = ZILEAN_ENABLED == 'true'
